Public Class Form2
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        btnOutputFolder.Image = SystemIcons.WinLogo.ToBitmap()
        btnOutputFolder.Text = ""
        btnOutputFolder.Image = SystemIcons.WinLogo.ToBitmap()
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnInputFolder.Click
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnOutputFolder.Click
        Dim dlg As New FolderBrowserDialog() With
        {
        .ShowNewFolderButton = False,
